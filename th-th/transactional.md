...
| `cost`                           | number              | เครดิตที่ใช้ คิดเป็นจำนวนเต็ม                 |
...
| `Blocked`            | ผู้รับถูกบล็อกจาก blocklist                |
...
*การตัดเครดิตเกิดขึ้นเฉพาะการส่งครั้งแรกของผู้รับรายนั้น ครั้งถัดไปจะถูกบล็อกจาก blocklist ของเรา
